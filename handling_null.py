...
print(df2.dropna(thresh = 3)) #thresh here sets the minimum of numbers of enteries other than nan should be present

print(df2.fillna(0))

print(df2.fillna({0:0, 1:50, 3:200}))